...
reg_model = tf.keras.models.load_model('salary_prediction__reg_model.h5')
...
model_choice = st.sidebar.selectbox("Choose a Model", ["Customer Churn", "Salary Prediction"])

if model_choice == "Customer Churn":
